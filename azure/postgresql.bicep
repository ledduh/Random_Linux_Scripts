...
param virtualNetworkName string = 'bicep_postgresql_vnet'

@description('Subnet Name')
param subnetName string = 'bicep_postgresql_subnet'

@description('Virtual Network RuleName')
param virtualNetworkRuleName string = 'AllowSubnet'

@description('Virtual Network Address Prefix')
param vnetAddressPrefix string = '10.7.0.0/16'

@description('Subnet Address Prefix')
param subnetPrefix string = '10.7.0.0/24'
...
resource server 'Microsoft.DBforPostgreSQL/servers@2017-12-01' = {
  ...
  properties: {
    ...
    administratorLogin: 'afyaR'
    administratorLoginPassword: 'afy R_'
    storageProfile: {
      storageMB: skuSizeMB
